...
export default function termsConditions({ html }) {
  return (
    <Box
      sx={{
        marginTop: "30px",
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p>Welcome to querydocuments!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of querydocuments's Website, located at querydocuments.com/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use querydocuments if you do not
          ...
          <p>
            We employ the use of cookies. By accessing querydocuments, you
            agreed to use cookies in agreement with the querydocuments's Privacy
            Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, querydocuments and/or its licensors own the
            intellectual property rights for all material on querydocuments. All
            intellectual property rights are reserved. You may access this from
            querydocuments for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from querydocuments</li>
            <li>Sell, rent or sub-license material from querydocuments</li>
            <li>Reproduce, duplicate or copy material from querydocuments</li>
            <li>Redistribute content from querydocuments</li>
          </ul>
          ...
          <p>
            ...
            querydocuments does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of querydocuments,its agents and/or affiliates.
            ...
            querydocuments shall not be liable for the Comments or for any
          ...
          <p>
            querydocuments reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant querydocuments a non-exclusive license to use,
          ...
          <p>
            ...
            querydocuments; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to querydocuments. Please include your name, your
          ...
          <p>
            No use of querydocuments's logo or other artwork will be allowed for
